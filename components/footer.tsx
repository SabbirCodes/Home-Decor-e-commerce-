    ...
    <footer className="bg-dusk text-cream/90 mt-24">
      <div className="mx-auto max-w-7xl px-5 sm:px-8 py-16">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-10">
          <div className="col-span-2">
            ...
            <p className="mt-4 text-sm text-cream/50 max-w-xs leading-relaxed">
              Considered furniture, lighting, and objects — sourced from makers
              who work in small batches, built to outlast trend cycles.
            </p>
        ...
        <div className="mt-14 pt-6 border-t border-cream/10 flex flex-col sm:flex-row justify-between gap-3 text-xs text-cream/35">
          <span>
            © {new Date().getFullYear()} Ferrous &amp; Field. All rights
            reserved.
          </span>
          <span className="font-mono">
            Made with care, shipped with patience.
          </span>
        </div>
      </div>
    </footer>
